 ...
 * </p>
 * <ul>
 *   <li>{@link tools.descartes.dlim.impl.NormalNoiseImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link tools.descartes.dlim.impl.NormalNoiseImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NormalNoiseImpl extends NoiseImpl implements NormalNoise {
    ...
    public void setMean(double newMean) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DlimPackage.NORMAL_NOISE__MEAN, oldMean, mean));
    }
    ...
    public void setStandardDeviation(double newStandardDeviation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DlimPackage.NORMAL_NOISE__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation));
    }
