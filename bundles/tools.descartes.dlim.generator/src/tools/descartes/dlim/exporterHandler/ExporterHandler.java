...
public final class ExporterHandler {
    ...
    private void evaluate(IExtensionRegistry registry) {
        ...
        try {
            ...
            DlimGeneratorPlugin.INSTANCE.log(new Status(Status.INFO, Activator.PLUGIN_ID, ex.getMessage(), ex));
        }
    }
     ...
     *
     * @param exporterIndex
     *            index of Exporter plugin in the list of registered plugins
     * @param projectPath
     ...
     */
    public void executeExtension(final int exporterIndex, final String projectPath, final String modelPath,
        ...
        ISafeRunnable runnable = new ISafeRunnable() {
            ...
            public void handleException(Throwable e) {
                DlimGeneratorPlugin.INSTANCE
                    .log(new Status(Status.INFO, Activator.PLUGIN_ID, "Exception in client", e));
            }
