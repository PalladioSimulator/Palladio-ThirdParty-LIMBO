...
public final class ExtractorHandler {
    ...
    private void evaluate(IExtensionRegistry registry) {
        ...
        try {
            for (IConfigurationElement e : config) {
                final Object extr = e.createExecutableExtension("extractor_class");
    ...
    /**
     * Execute an extractor at the given index within the list of registered Extractors. The index
     * corresponds to its label index within the ordered label list.
     *
     * @param extractorIndex
     *            Index of Extension point implementation in list of extractors
     ...
     */
    public void executeExtension(final int extractorIndex, final String arrivalRateFilePath, final Sequence rootObject,
            final double offset) {
