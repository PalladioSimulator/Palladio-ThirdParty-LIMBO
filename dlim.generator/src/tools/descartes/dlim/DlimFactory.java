...
public interface DlimFactory extends EFactory {
	/**
	 * The singleton instance of the factory. This returns an instance of the
	 * hand-written CustomDlimFactoryImpl, allowing for model element impl
	 * modification in custom classes within the dlim.impl.custom package.
	 * 
	 * @generated not
	 */
	DlimFactory eINSTANCE = tools.descartes.dlim.impl.custom.CustomDlimFactoryImpl
			.init();
